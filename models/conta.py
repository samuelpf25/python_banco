...
class Conta:
    ...
    @limite.setter
    def limite(self: object, valor: float):
        self.__limite = valor
    ...
    @saldo_total.setter
    def saldo_total(self: object, total: float) -> None:
        self.__saldo_total = total
    ...
    def depositar(self: object, valor: float) -> None:
        if valor > 0:
            ...
            print('Erro ao efetuar depósito. Tenta novamente.')
    ...
    def sacar(self: object, valor: float) -> None:
        if valor > 0 and self.saldo_total >= valor:
            ...
            print('Erro ao efetuar saque. Tenta novamente.')
    ...
    def transferir(self: object, destino: object, valor: float) -> None:
        if valor > 0 and self.saldo_total >= valor:
            ...
            print('Erro ao efetuar transferência. Tenta novamente.')
